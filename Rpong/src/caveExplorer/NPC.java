...
public class NPC {
	...
	public NPC() {
		...
		//You can make custom constructors later on that use different parameters
		// I.e. public NPC(String description, String inactiveDescription)
	}
